...
emailRef.addEventListener("input", (0, _lodashThrottleDefault.default)((e)=>{
    formData.email = e.target.value;
    saveInfo(STORAGE_KEY, formData);
}, 350));
messageRef.addEventListener("input", (0, _lodashThrottleDefault.default)((e)=>{
...
function getData(value) {
    try {
        ...
        if (dataInfo) return JSON.parse(dataInfo);
    } catch (error) {
        console.log("error ", error.message);
    }
}
